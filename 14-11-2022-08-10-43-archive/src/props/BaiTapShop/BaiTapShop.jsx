...
export default class BaiTapShop extends Component {

    
    renderProduct = () => {

        const arrJSXDiv = data.map((item, index) => {
    ...
    */
        ...
        // return[ <div key={1} className='col-4'>1</div>,<div key={2} className='col-4'>2</div> ]
    }
